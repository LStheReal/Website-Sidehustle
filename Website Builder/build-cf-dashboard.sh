...
# Replace version param with current timestamp for cache busting
sed -i '' "s/dashboard\.js?v=[^\"']*/dashboard.js?v=$CACHE_VERSION/" "$DIST/onboarding.html"
sed -i '' "s/dashboard\.css/dashboard.css?v=$CACHE_VERSION/" "$DIST/onboarding.html"
...
# Create _headers for caching + security
